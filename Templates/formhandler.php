...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: stenbergdigeronimo@gmail.com' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Email from Anthony Developed This'; // if your client has more than one web site, you can put the site name here.
...
mail ('stenbergdigeronimo@gmail.com', $subject, $body, $from);
